...
class Student: Person{
    ...
    override func introduction() -> String{
        ...
        if let savings = super.father?.savings{
            introduceStudent += ".My father has $\(savings) savings"
        }else if let savings = super.mother?.savings{
            introduceStudent += ".My mother has $\(savings) savings"
        }else{
...
var ismet: Parent?
ismet = Parent(name: "Ismet", lastName: "Halep", yearOfBirth: 1946, location: coords3, children: [aida , student])
var ilduza: Parent?
ilduza = Parent(name: "Ilduza", lastName: "Halep", yearOfBirth: 1951, location: coords3, children: [aida, student])
